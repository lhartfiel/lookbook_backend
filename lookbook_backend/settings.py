"""
Django settings for lookbook_backend project.
...
INSTALLED_APPS = [
    ...
    "taggit",
    "corsheaders",
    # Local apps (will be created in subsequent tasks)
    "styles",
    # "search",
]
...
ROOT_URLCONF = "lookbook_backend.urls"
...
WSGI_APPLICATION = "lookbook_backend.wsgi.application"
...
cors_origins_env = os.getenv(
    ...
    "http://localhost:3000,http://localhost:8000,http://127.0.0.1:8000,https://lookbook-lhartfiel.pythonanywhere.com,https://hairstyleslookbook.netlify.app"
)
